...
public record AgentToServerDomain(UUID instanceId, Long seqNum, AgentDescriptionDomain description, Long capabilities,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(flags, that.flags)
                ...
                && Objects.equals(effectiveConfig, that.effectiveConfig)
                && Objects.equals(agentDisconnect, that.agentDisconnect)
                && Objects.equals(packagesStatuses, that.packagesStatuses)
                && Objects.equals(componentHealth, that.componentHealth)
                && Objects.equals(remoteConfigStatus, that.remoteConfigStatus);
    }

    // skip the sequence
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, description, capabilities, componentHealth, effectiveConfig, remoteConfigStatus, packagesStatuses, agentDisconnect, flags);
    }
}
